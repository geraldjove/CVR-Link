...
foreach($oldVersion in '0.1.0','0.2.0','0.2.1','0.2.2','0.2.3','0.2.4','0.2.5','0.2.6','0.2.7','0.2.8'){
...
Assert ($upgraded.version -eq '0.2.9' -and (Test-LinkInstalled $Payload $state)) 'Upgrade replaces the old runtime and records 0.2.9'
