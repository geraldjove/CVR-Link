...
foreach($oldVersion in '0.1.0','0.2.0'){
...
Assert ($upgraded.version -eq '0.2.1' -and (Test-LinkInstalled $Payload $state)) 'Upgrade replaces the old runtime and records 0.2.1'
