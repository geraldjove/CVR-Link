...
function Add-Shortcuts {
    ...
    foreach($entry in @{DisplayName='CVR Link';DisplayVersion='0.2.0';Publisher='_mintyfishy';DisplayIcon=$Executable;UninstallString=('"'+$Executable+'" --uninstall');URLInfoAbout='https://github.com/geraldjove/CVR-Link'}.GetEnumerator()){
