...
check(pawn.sprinting,'Shift requests native sprint')
pawn.CharacterMovement.Velocity.X=550
local crouch_started=now
input({LeftShift=true,LeftControl=true})
...
input({LeftShift=true,C=true}); tick()
...
now=now+.5
input({LeftShift=true}); input({LeftShift=true,LeftControl=true})
