...
function M.defaults()
    local result={mouse=2.5,aim=1,ui_scale=1,ui_opacity=1,experimental_start=false,keys={}}
...
function M.validate(value)
    ...
    local result={mouse=value.mouse,aim=value.aim,ui_scale=scale,ui_opacity=opacity,experimental_start=experimental,keys={}}
    local used={}
...
function M.parse(text)
    ...
    for line in text:gmatch('[^\r\n]+') do
        ...
        seen[name]=true
        if name=='mouse' or name=='aim' or name=='ui_scale' or name=='ui_opacity' then
...
function M.encode(value)
    ...
    local lines={'mouse='..checked.mouse,'aim='..checked.aim,'ui_scale='..checked.ui_scale,'ui_opacity='..checked.ui_opacity,
